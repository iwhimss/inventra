...
│       │   └── widgets/          ← CustomTitleBar (v0.2.1-patch: MaterialApp.builder'da global katman, tüm sayfa/dialogların üzerinde; v0.2.1-patch2: tam opak, blur yok), ortak bileşenler
│       └── features/
